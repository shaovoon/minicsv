...
template<typename T>
mini_180::csv::ifstream& operator >> (mini_180::csv::ifstream& istm, T& val)
{
...
template<>
inline mini_180::csv::ifstream& operator >> (mini_180::csv::ifstream& istm, std::string& val)
{
...
template<>
inline mini_180::csv::ifstream& operator >> (mini_180::csv::ifstream& istm, mini_180::csv::sep& val)
{
...
template<typename T>
mini_180::csv::ofstream& operator << (mini_180::csv::ofstream& ostm, const T& val)
{
...
template<>
inline mini_180::csv::ofstream& operator << (mini_180::csv::ofstream& ostm, const std::string& val)
{
	if (!ostm.get_after_newline())
		ostm.get_ofstream() << ostm.get_delimiter();
...
template<>
inline mini_180::csv::ofstream& operator << (mini_180::csv::ofstream& ostm, const mini_180::csv::sep& val)
{
...
template<>
inline mini_180::csv::ofstream& operator << (mini_180::csv::ofstream& ostm, const char& val)
{
	if(val==NEWLINE)
	{
...
template<typename T>
mini_180::csv::istringstream& operator >> (mini_180::csv::istringstream& istm, T& val)
{
	std::string str = istm.get_delimited_str();
...
template<>
inline mini_180::csv::istringstream& operator >> (mini_180::csv::istringstream& istm, std::string& val)
{
	val = istm.get_delimited_str();
...
template<>
inline mini_180::csv::istringstream& operator >> (mini_180::csv::istringstream& istm, mini_180::csv::sep& val)
{
	istm.set_delimiter(val.get_delimiter(), val.get_escape());
...
template<typename T>
mini_180::csv::ostringstream& operator << (mini_180::csv::ostringstream& ostm, const T& val)
{
	if (!ostm.get_after_newline())
...
template<>
inline mini_180::csv::ostringstream& operator << (mini_180::csv::ostringstream& ostm, const std::string& val)
{
	if (!ostm.get_after_newline())
		ostm.get_ostringstream() << ostm.get_delimiter();
...
template<>
inline mini_180::csv::ostringstream& operator << (mini_180::csv::ostringstream& ostm, const mini_180::csv::sep& val)
{
	ostm.set_delimiter(val.get_delimiter(), val.get_escape());
...
template<>
inline mini_180::csv::ostringstream& operator << (mini_180::csv::ostringstream& ostm, const char& val)
{
	if (val == NEWLINE)
	{
